...
# Za razliku od funkcije iz 3b, ovde mozemo uociti da se najbolji rezultat dobija
# za k = 1, nakon cega funkcija opada znacajno vec za k = 2,
# ima skokova i padova, ali  najcesce je generalno opadajuca, accuracy za k = 1
# je najcesce oko 0.95, za razliku od funkcije iz 3b varijacije su nesto vece,
# mogu da idu do 0.2
